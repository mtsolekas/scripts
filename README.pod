...
=item B<data_crypt.pl> -e|-d [output] input
...
successful encryption/decryption the input directory/file input is deleted.
...
~/.config/repository_watch.conf. The config file has the following syntax:
    ...
    upstream_username1 upstream_reponame1 origin_username1 origin_reponame1
    upstream_username2 upstream_reponame2 origin_username2 origin_reponame2
