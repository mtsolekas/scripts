...
Opus Download will download the video from the given youtube url in
webm format and extract the opus file from it. It uses the
WWW::YouTube::Download module and the avconv tool.
